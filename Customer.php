...
<!--Search-->
  ...
  <form>  
      <div class="customer-search">     
        <input type="text" class="search-design" placeholder="Search Customer...">
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr style="height:25px; ">
        ...
        <td style="border:1px solid #333; text-align: center;">
          <a href="delete_customer.php?Customer_ID=<?php echo md5($row['Customer_ID']);?>">
            ...
            <form action="add_customer.php" method="POST">
             <div class="form-group row">
                <label for="inputName" class="col-sm-3 col-form-label">Name:</label>
                  <div class="col-sm-7">
                    <input type="mame" class="form-control" name="name" id="inputName" placeholder="Customer Name" required>
                  </div>  
              </div>        
              ...
              <div class="form-group row">
                <label for="inputAddress" class="col-sm-3 col-form-label">Address:</label>
                  <div class="col-sm-7">
                    <input type="address" name="address" class="form-control" id="inputName" placeholder="Address" required>
                  </div>
              </div>        
              ...
              <div class="form-group row">
                <label for="inputContact" class="col-sm-3 col-form-label">Number:</label>
                  <div class="col-sm-7">
                    <input type="contact" name="contact" class="form-control" id="inputName" placeholder="Contact"  required>
                  </div>
              </div>
