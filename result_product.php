     ...
     <th colspan="6" align="center" height="55px" style="border-bottom:1px solid #033; background-color: #242A33; color:#FFF; text-align: center; font-size: 20px;"> Supplier Information Table</th>
      ...
      <tr align="center" style="height:25px; ">
        ...
        <td style="border:1px solid #333;text-align: center; ">
          ...
          <a href="#edit<?php echo $row['Product_ID']; ?>" data-toggle="modal" class="btn btn-warning" > <span class="far fa-edit"></span > Edit</a> ||

          <a href="delete_product.php?Product_ID=<?php echo md5($row['Product_ID']);?>" class="btn btn-danger">
    ...
    <div class="modal-dialog"  role="document">
      ...
      <form action="add_product.php" method="POST"> 
            ...
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">Catecogry:</label>
                <div class="col-sm-7">
